...
<center>
	<div class="container" style="padding-right: 100px; padding-left: 100px;">
		<div class="card-panel z-depth-3">
			...
			<?php else: ?>
				<form method="post" id="formValidate" action="<?php echo base_url('/dashboard/adduser');?>" novalidate="novalidate">
					...
					<div class='row s12' style="padding-right: 50px; padding-left: 50px;">
						...
						<div class="input-field col s12">
							<select name="user_lvl" required="required">
