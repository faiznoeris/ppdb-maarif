...
<a class="waves-effect waves-light btn grey darken-2" href="<?= base_url('/laporan/pendaftar_all'); ?>">Export Data (Semua Jurusan)</a>

<div class="row" id="jurusan_tav">
  <div id="admin" class="col s12">
    <div class="card material-table">
      <div class="table-header">
        <span class="table-title">Data Pendaftar Teknik Audio Video</span>
        <div class="actions">
...
<div class="row" id="jurusan_tkr">
  <div id="admin" class="col s12">
    <div class="card material-table">
      <div class="table-header">
        <span class="table-title">Data Pendaftar Teknik Kendaraan Ringan</span>
        <div class="actions">
...
<div class="row" id="jurusan_tkj">
  <div id="admin" class="col s12">
    <div class="card material-table">
      <div class="table-header">
        <span class="table-title">Data Pendaftar Teknik Komputer Jaringan</span>
        <div class="actions">
          <a href="#" class="search-toggle waves-effect btn-flat nopadding"><i class="material-icons">search</i></a>
        </div>
      </div>
...
<div class="row" id="jurusan_tab">
  <div id="admin" class="col s12">
    <div class="card material-table">
      <div class="table-header">
        <span class="table-title">Data Pendaftar Teknik Alat Berat</span>
        <div class="actions">
