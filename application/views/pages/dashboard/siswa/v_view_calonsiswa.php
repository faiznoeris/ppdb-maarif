  ...
  <div class="card-panel">
    <div class="row">
      <center>
        ...
        <a class="waves-effect waves-light btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Unduh detail data pendaftar <?= $data_siswa->nm_lengkap ?>" href="<?= base_url('laporan/laporansiswa/'.$data_siswa->id_pendaftar."/".$data_siswa->nm_lengkap); ?>"><i class="material-icons" style="font-size: 25px;">get_app</i></a>
