        ...
        <div class="row">
          <form id="formValidate" method="post" action="<?php echo base_url('calonsiswa/saveedit/'.$data_siswa->id_pendaftar);?>">
            ...
            <!-- ALAMAT -->
              ...
              $afterDesa    = substr($alamat, strpos($alamat, 'Desa'));
              $afterRT      = substr($alamat, strpos($alamat, 'RT'));
              $afterRW      = substr($alamat, strpos($alamat, 'RW'));
              $afterKec     = substr($alamat, strpos($alamat, 'Kecamatan'));
              $afterKab     = substr($alamat, strpos($alamat, 'Kabupaten'));
              $afterKodePos = substr($alamat, strpos($alamat, 'Kode Pos'));
              $Desa         = substr($afterDesa, 0, strpos($afterDesa, "RT"));
              $RT           = substr($afterRT, 0, strpos($afterRT, "RW"));
              $RW           = substr($afterRW, 0, strpos($afterRW, "Kecamatan"));
              $Kecamatan    = substr($afterKec, 0, strpos($afterKec, "Kabupaten"));
              $Kabupaten    = substr($afterKab, 0, strpos($afterKab, "Kode Pos"));
            ...
            <div class="row">
              ...
              <div class="input-field col s4">
                <select name="select_kecamatan" id="select_kecamatan">]
                  <?php if(strpos($Kecamatan, "PU001") !== false): ?>
                    <option value="PU001" selected="">Purwokerto Utara</option>
                    <option value="PU002">Purwokerto Timur</option>
                  <?php elseif(strpos($Kecamatan, "PU002") !== false): ?>
                    <option value="PU001">Purwokerto Utara</option>
                    <option value="PU002" selected="">Purwokerto Timur</option>
                  <?php endif; ?>
                </select>
              ...
              <div class="input-field col s6">
                <select name="select_kabupaten" id="select_kabupaten" >
                  <?php if(strpos($Kabupaten, "PU001") !== false): ?>
                    <option value="PU001">Banyumas</option>
                    <option value="PU002">Purbalingga</option>
                  <?php elseif(strpos($Kabupaten, "PU002") !== false): ?>
                    <option value="PU001">Banyumas</option>
                    <option value="PU002">Purbalingga</option>
                  <?php endif; ?>
                </select>
