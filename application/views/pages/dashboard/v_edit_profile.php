 		...
 		<center>
 			<div class="row s12 z-depth-1">
 				<div class="row s12" style="padding: 32px 48px 32px 48px;">
 					<form method="post" id="formValidate" action="<?php echo base_url('/profile/updateprofile');?>" enctype='multipart/form-data'>
 						<div class="col s6">
 							...
 							<div class="file-field input-field" style="width: 75%;">
 								...
 								<div class="file-path-wrapper">
 									<input class="file-path validate" type="text" placeholder="Max. 284x284, 1MB">
 								</div>
 							</div>
 						</div>
